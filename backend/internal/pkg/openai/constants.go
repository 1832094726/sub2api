...
func CodexBaseInstructionsForModel(model string) string {
	...
	switch {
	case canonical == "gpt-6" || canonical == "gpt-6-astra" || canonical == "gpt-6-sol" || canonical == "gpt-6-luna" || strings.HasPrefix(canonical, "gpt-6-astra-") || strings.HasPrefix(canonical, "gpt-6-sol-") || strings.HasPrefix(canonical, "gpt-6-luna-"):
