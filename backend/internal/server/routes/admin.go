...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/import-snapshot", h.Admin.Account.GetImportSnapshot)
		accounts.POST("/:id/import-snapshot/reveal", h.Admin.Account.RevealImportSnapshot)
		...
		accounts.POST("/cleanup-invalid-no-refresh-token", h.Admin.Account.CleanupInvalidNoRefreshToken)
