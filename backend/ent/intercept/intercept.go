...
// The AccountImportSnapshotFunc type is an adapter to allow the use of ordinary function as a Querier.
type AccountImportSnapshotFunc func(context.Context, *ent.AccountImportSnapshotQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AccountImportSnapshotFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AccountImportSnapshotQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AccountImportSnapshotQuery", q)
}

// The TraverseAccountImportSnapshot type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAccountImportSnapshot func(context.Context, *ent.AccountImportSnapshotQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAccountImportSnapshot) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAccountImportSnapshot) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AccountImportSnapshotQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AccountImportSnapshotQuery", q)
}
...
// The ImagePrimaryTaskFunc type is an adapter to allow the use of ordinary function as a Querier.
type ImagePrimaryTaskFunc func(context.Context, *ent.ImagePrimaryTaskQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ImagePrimaryTaskFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ImagePrimaryTaskQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ImagePrimaryTaskQuery", q)
}

// The TraverseImagePrimaryTask type is an adapter to allow the use of ordinary function as Traverser.
type TraverseImagePrimaryTask func(context.Context, *ent.ImagePrimaryTaskQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseImagePrimaryTask) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseImagePrimaryTask) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ImagePrimaryTaskQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ImagePrimaryTaskQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.AccountImportSnapshotQuery:
		return &query[*ent.AccountImportSnapshotQuery, predicate.AccountImportSnapshot, accountimportsnapshot.OrderOption]{typ: ent.TypeAccountImportSnapshot, tq: q}, nil
	...
	case *ent.ImagePrimaryTaskQuery:
		return &query[*ent.ImagePrimaryTaskQuery, predicate.ImagePrimaryTask, imageprimarytask.OrderOption]{typ: ent.TypeImagePrimaryTask, tq: q}, nil
