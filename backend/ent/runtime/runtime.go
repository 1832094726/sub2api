...
func init() {
	...
	usagelogDescImageChannel := usagelogFields[35].Descriptor()
	...
	usagelogDescPrimaryTaskID := usagelogFields[36].Descriptor()
	...
	usagelogDescFallbackReason := usagelogFields[38].Descriptor()
