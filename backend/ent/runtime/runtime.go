...
func init() {
	...
	usagelogDescImageChannel := usagelogFields[36].Descriptor()
	...
	usagelogDescPrimaryTaskID := usagelogFields[37].Descriptor()
	...
	usagelogDescFallbackReason := usagelogFields[39].Descriptor()
