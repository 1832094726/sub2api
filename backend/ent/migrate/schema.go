...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "image_channel", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "primary_task_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "primary_duration_ms", Type: field.TypeInt, Nullable: true},
		{Name: "fallback_reason", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "fallback_duration_ms", Type: field.TypeInt, Nullable: true},
