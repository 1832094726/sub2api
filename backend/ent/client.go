...
type Client struct {
	...
	// AccountImportSnapshot is the client for interacting with the AccountImportSnapshot builders.
	AccountImportSnapshot *AccountImportSnapshotClient
...
func (c *Client) init() {
	...
	c.AccountImportSnapshot = NewAccountImportSnapshotClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		AccountImportSnapshot:         NewAccountImportSnapshotClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.APIKey, c.Account, c.AccountGroup, c.AccountImportSnapshot, c.Announcement,
		...
		c.ChannelMonitorRequestTemplate, c.CompositeModelRoute, c.ErrorPassthroughRule, c.Group,
		c.IdempotencyRecord, c.IdentityAdoptionDecision, c.ImagePrimaryTask,
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *AccountImportSnapshotMutation:
		return c.AccountImportSnapshot.mutate(ctx, m)
...
// AccountImportSnapshotClient is a client for the AccountImportSnapshot schema.
type AccountImportSnapshotClient struct {
	config
}

// NewAccountImportSnapshotClient returns a client for the AccountImportSnapshot from the given config.
func NewAccountImportSnapshotClient(c config) *AccountImportSnapshotClient {
	return &AccountImportSnapshotClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `accountimportsnapshot.Hooks(f(g(h())))`.
func (c *AccountImportSnapshotClient) Use(hooks ...Hook) {
	c.hooks.AccountImportSnapshot = append(c.hooks.AccountImportSnapshot, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `accountimportsnapshot.Intercept(f(g(h())))`.
func (c *AccountImportSnapshotClient) Intercept(interceptors ...Interceptor) {
	c.inters.AccountImportSnapshot = append(c.inters.AccountImportSnapshot, interceptors...)
}

// Create returns a builder for creating a AccountImportSnapshot entity.
func (c *AccountImportSnapshotClient) Create() *AccountImportSnapshotCreate {
	mutation := newAccountImportSnapshotMutation(c.config, OpCreate)
	return &AccountImportSnapshotCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AccountImportSnapshot entities.
func (c *AccountImportSnapshotClient) CreateBulk(builders ...*AccountImportSnapshotCreate) *AccountImportSnapshotCreateBulk {
	return &AccountImportSnapshotCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AccountImportSnapshotClient) MapCreateBulk(slice any, setFunc func(*AccountImportSnapshotCreate, int)) *AccountImportSnapshotCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AccountImportSnapshotCreateBulk{err: fmt.Errorf("calling to AccountImportSnapshotClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AccountImportSnapshotCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AccountImportSnapshot.
func (c *AccountImportSnapshotClient) Update() *AccountImportSnapshotUpdate {
	mutation := newAccountImportSnapshotMutation(c.config, OpUpdate)
	return &AccountImportSnapshotUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AccountImportSnapshotClient) UpdateOne(_m *AccountImportSnapshot) *AccountImportSnapshotUpdateOne {
	mutation := newAccountImportSnapshotMutation(c.config, OpUpdateOne, withAccountImportSnapshot(_m))
	return &AccountImportSnapshotUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AccountImportSnapshotClient) UpdateOneID(id int64) *AccountImportSnapshotUpdateOne {
	mutation := newAccountImportSnapshotMutation(c.config, OpUpdateOne, withAccountImportSnapshotID(id))
	return &AccountImportSnapshotUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AccountImportSnapshot.
func (c *AccountImportSnapshotClient) Delete() *AccountImportSnapshotDelete {
	mutation := newAccountImportSnapshotMutation(c.config, OpDelete)
	return &AccountImportSnapshotDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AccountImportSnapshotClient) DeleteOne(_m *AccountImportSnapshot) *AccountImportSnapshotDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AccountImportSnapshotClient) DeleteOneID(id int64) *AccountImportSnapshotDeleteOne {
	builder := c.Delete().Where(accountimportsnapshot.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AccountImportSnapshotDeleteOne{builder}
}

// Query returns a query builder for AccountImportSnapshot.
func (c *AccountImportSnapshotClient) Query() *AccountImportSnapshotQuery {
	return &AccountImportSnapshotQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAccountImportSnapshot},
		inters: c.Interceptors(),
	}
}

// Get returns a AccountImportSnapshot entity by its id.
func (c *AccountImportSnapshotClient) Get(ctx context.Context, id int64) (*AccountImportSnapshot, error) {
	return c.Query().Where(accountimportsnapshot.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AccountImportSnapshotClient) GetX(ctx context.Context, id int64) *AccountImportSnapshot {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AccountImportSnapshotClient) Hooks() []Hook {
	return c.hooks.AccountImportSnapshot
}

// Interceptors returns the client interceptors.
func (c *AccountImportSnapshotClient) Interceptors() []Interceptor {
	return c.inters.AccountImportSnapshot
}

func (c *AccountImportSnapshotClient) mutate(ctx context.Context, m *AccountImportSnapshotMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AccountImportSnapshotCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AccountImportSnapshotUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AccountImportSnapshotUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AccountImportSnapshotDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown AccountImportSnapshot mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		APIKey, Account, AccountGroup, AccountImportSnapshot, Announcement,
		...
		ErrorPassthroughRule, Group, IdempotencyRecord, IdentityAdoptionDecision, ImagePrimaryTask,
