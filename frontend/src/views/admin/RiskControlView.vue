        ...
        <div class="space-y-6">
          ...
          <div v-else-if="activeSettingsTab === 'response'" class="space-y-5">
            <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
              ...
              <div class="flex items-center justify-between rounded-lg border border-gray-100 p-4 dark:border-dark-700 lg:col-span-2">
                <div><p class="text-sm font-medium">{{ t('admin.riskControl.cyberUserBlock') }}</p>
                <p class="mt-1 text-xs text-gray-500">{{ t('admin.riskControl.cyberUserBlockHint') }}</p></div>
                <Toggle v-model="configForm.cyber_user_block_enabled" />
              </div>
              <div>
...
const configForm = reactive({
  ...
  cyber_user_block_enabled: false,
...
function applyConfig(config: ContentModerationConfig) {
  ...
  configForm.cyber_user_block_enabled = config.cyber_user_block_enabled ?? false
...
async function saveConfig() {
  ...
  try {
    ...
    const payload: UpdateContentModerationConfig = {
      ...
      cyber_user_block_enabled: configForm.cyber_user_block_enabled,
